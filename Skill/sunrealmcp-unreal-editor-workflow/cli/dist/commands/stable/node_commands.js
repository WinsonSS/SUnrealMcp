...
export function register(registry) {
    ...
    registerCommand(registry, {
        ...
        mapParams(values) {
            ...
            if (values.node_type !== undefined)
                params.node_type = values.node_type;
            if (values.event_type !== undefined)
    ...
    registerCommand(registry, {
        ...
        mapParams(values) {
            ...
            if (values.graph_type !== undefined)
                params.graph_type = values.graph_type;
            if (values.graph_name !== undefined)
                params.graph_name = values.graph_name;
            return params;
        },
    });
    registerCommand(registry, {
