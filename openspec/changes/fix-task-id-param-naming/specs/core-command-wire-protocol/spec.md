...
**例外 1（envelope）**：由 `ProtocolVersion = 1` 定义的 envelope 字段——具体为 `protocolVersion`、`requestId`、`ok`、`data`、`error`、`error.code`、`error.message`、`error.details`——不在本规则范围内，继续保持现有的 camelCase 形式。
