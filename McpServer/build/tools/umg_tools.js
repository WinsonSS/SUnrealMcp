...
export function register(server) {
    server.registerTool("create_umg_widget_blueprint", {
    ...
    server.registerTool("add_text_block_to_widget", {
    ...
    server.registerTool("add_button_to_widget", {
    ...
    server.registerTool("bind_widget_event", {
    ...
    server.registerTool("add_widget_to_viewport", {
    ...
    server.registerTool("set_text_block_binding", {
