...
export function register(server) {
    ...
    server.registerTool("add_component_to_blueprint", {
    ...
    server.registerTool("set_static_mesh_properties", {
    ...
    server.registerTool("set_component_property", {
    ...
    server.registerTool("set_physics_properties", {
    ...
    server.registerTool("compile_blueprint", {
    ...
    server.registerTool("set_blueprint_property", {
