...
export function register(server) {
    server.registerTool("add_blueprint_event_node", {
    ...
    server.registerTool("add_blueprint_input_action_node", {
    ...
    server.registerTool("add_blueprint_function_node", {
    ...
    server.registerTool("connect_blueprint_nodes", {
    ...
    server.registerTool("add_blueprint_variable", {
    ...
    server.registerTool("add_blueprint_get_self_component_reference", {
    ...
    server.registerTool("add_blueprint_self_reference", {
    ...
    server.registerTool("find_blueprint_nodes", {
